        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section">eCommerce Store Login</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                    ...
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <form action="{{ route('user.login') }}" method="post" class="login-form">
                            ...
                            <div class="form-group">
                                <input type="email" name="email" id="email" placeholder="name@example.com" class="form-control rounded-left" required>
                            </div>
                            <div class="form-group d-flex">
                                <input type="password" name="password" id="password" class="form-control rounded-left" placeholder="Password" required>
                            </div>
                            <div class="form-group">
                                <button type="submit" style="background-color: #343a40; color:white;" class="form-control btn  rounded submit px-3">Login</button>
                            </div>
                            <div class="form-group d-md-flex">
                                <div class="w-50">
                                    <label class="checkbox-wrap checkbox-dark">Remember Me
